    ...
    <>
      <div className="project">
        <div className="project-description">
          <a href="https://memento-hqc5.onrender.com" target="_blank" rel="noreferrer" className="title"><img src={share} className="non-draggable" alt="share-icon" /> Memento</a>
        ...
        <div className={ condition1 ? "shadow project-view": "project-view" }>
      ...
      <div className="project">
        ...
        <div className={ condition2 ? "shadow project-view": "project-view" }>
          <img className={ condition2 ? "img1": "" } src={ memento1 } alt="project Memento" loading="lazy" />
          <img src={memento2} alt="project Memento" loading="lazy" />
          <img className={ condition2 ? "img2" : "" } src={ memento3 } alt="project Memento" loading="lazy" />
        </div>
      </div>
    </>
  );
